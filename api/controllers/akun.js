...
exports.updateAkun = async(req,res)=>{
    try {
        ...
        return res.status(200).json({ message: "Akun berhasil diperbarui", updatedAccount: akun });
    } catch (error) {
        console.error("Error updating account:", error);
        return res.status(500).json({ message: "Terjadi kesalahan saat memperbarui akun", error });
    }
}
